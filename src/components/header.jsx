  ...
  return (
    <StyledHeader>
        <Inner>
          <Top>
            <UserBar>
              <UserBarText purple>회원가입</UserBarText>
              <Bar />
              <UserBarText>로그인</UserBarText>
              <Bar />
              <UserBarText>고객센터 ▼</UserBarText>
            </UserBar>
          </Top>

          <Middle>
            <LogoContainer><Link to='/'></Link></LogoContainer>
            <ModeBox><MarketMode>마켓컬리</MarketMode><MiddleBar /><BeautyMode>뷰티컬리</BeautyMode></ModeBox>
            <SearchBar/>
            <UserButtons/>
          </Middle>
...
const BeautyMode = styled.button`
  font-weight: normal;
  flex-shrink: 0;
  font-size: 18px;
  line-height: 1.33;
...
const MarketMode = styled.button`
  font-weight: 500;
  color: rgb(95, 0, 128);
  flex-shrink: 0;
  font-size: 18px;
...
`
const UserBarText = styled.li`
  color: ${props => props.purple ? "rgb(95, 0, 128)" : "#333"};
